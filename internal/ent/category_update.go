...
func (_u *CategoryUpdate) SetSuggestedPercentage(v int) *CategoryUpdate {
	_u.mutation.ResetSuggestedPercentage()
	_u.mutation.SetSuggestedPercentage(v)
	return _u
}

// SetNillableSuggestedPercentage sets the "suggested_percentage" field if the given value is not nil.
func (_u *CategoryUpdate) SetNillableSuggestedPercentage(v *int) *CategoryUpdate {
	if v != nil {
		_u.SetSuggestedPercentage(*v)
	}
	return _u
}

// AddSuggestedPercentage adds value to the "suggested_percentage" field.
func (_u *CategoryUpdate) AddSuggestedPercentage(v int) *CategoryUpdate {
	_u.mutation.AddSuggestedPercentage(v)
	return _u
}

// ClearSuggestedPercentage clears the value of the "suggested_percentage" field.
func (_u *CategoryUpdate) ClearSuggestedPercentage() *CategoryUpdate {
	_u.mutation.ClearSuggestedPercentage()
	return _u
}
...
func (_u *CategoryUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.SuggestedPercentage(); ok {
		_spec.SetField(category.FieldSuggestedPercentage, field.TypeInt, value)
	}
	if value, ok := _u.mutation.AddedSuggestedPercentage(); ok {
		_spec.AddField(category.FieldSuggestedPercentage, field.TypeInt, value)
	}
	if _u.mutation.SuggestedPercentageCleared() {
...
// SetSuggestedPercentage sets the "suggested_percentage" field.
func (_u *CategoryUpdateOne) SetSuggestedPercentage(v int) *CategoryUpdateOne {
	_u.mutation.ResetSuggestedPercentage()
	_u.mutation.SetSuggestedPercentage(v)
	return _u
}
...
// SetNillableSuggestedPercentage sets the "suggested_percentage" field if the given value is not nil.
func (_u *CategoryUpdateOne) SetNillableSuggestedPercentage(v *int) *CategoryUpdateOne {
	if v != nil {
		_u.SetSuggestedPercentage(*v)
	}
	return _u
...
// AddSuggestedPercentage adds value to the "suggested_percentage" field.
func (_u *CategoryUpdateOne) AddSuggestedPercentage(v int) *CategoryUpdateOne {
	_u.mutation.AddSuggestedPercentage(v)
	return _u
}

// ClearSuggestedPercentage clears the value of the "suggested_percentage" field.
func (_u *CategoryUpdateOne) ClearSuggestedPercentage() *CategoryUpdateOne {
	_u.mutation.ClearSuggestedPercentage()
	return _u
}
